...
Scope amendment, 2026-09-08: after the unresolved transient was explained, the user explicitly chose «Да забьем давай». The original-cause investigation criterion above is waived. R16 is accepted in its delivered scope with that documented limitation; no claim that the transient was reproduced, diagnosed or fixed. Existing diagnostics, regression tests and fail-closed/reconciliation behavior remain in place. This amendment supersedes the original requirement to keep R16 partial solely for that investigation.
