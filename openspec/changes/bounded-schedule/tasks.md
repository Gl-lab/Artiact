...
- [x] Specify policy, durable budgets, failure/restart behavior and notification channel.
- [x] Implement/test scheduler and durable series store with compiling RED.
