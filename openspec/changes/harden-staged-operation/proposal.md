...
- Fix known warning sources, replace the vulnerable/deprecated Zipkin exporter with a current OTLP exporter, correct Docker build context and strengthen offline CI.
