...
- [x] Inspect existing lifecycle and define R6 scope, acceptance and failure cases.
- [x] Add persistent-result tests before edits and safe archival tests; record exact RED/GREEN scope.
- [x] Implement lifecycle commands and durable report facts; preserve older checkpoints.
- [x] Prove target attainment after two bank deposits through real clients.
