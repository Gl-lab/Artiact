...
- [x] 1.1 Validate specification against ADR/handoff and current source; record baseline and source inspection.
- [x] 1.2 Commit specification before implementation.
