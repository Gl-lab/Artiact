...
- [x] Preregister additional outcomes, costs, state/stock and accumulated operational coverage.
- [x] Add compiling behavioral tests, then the minimum mock extensions.
- [x] Run and replay long/capacity/no-route comparisons and accumulated R12–R14 matrix.
