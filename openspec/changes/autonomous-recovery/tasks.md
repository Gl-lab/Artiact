...
- [x] Inspect existing supply/preparation and specify permissions, utility, state and numerical scenario expectations.
- [x] Add compiling RED policy/need tests before production edits.
- [x] Implement bounded recovery discovery, full-path estimates, global allowances and parent completion.
