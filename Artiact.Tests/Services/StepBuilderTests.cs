...
public class StepBuilderTests
{
    ...
    public async Task BuildCraftingSteps_WithValidCraftTarget_ShouldCreateCorrectSteps()
    {
        ...
        GearCraftingGoal goal = new GearCraftingGoal( craftTarget );
