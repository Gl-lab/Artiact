...
- Combat scenarios use `CombatScenario.json` and `CombatScenarioStore`/middleware. They support `researcher`, named combat-progression/combat-equipment reset, map-id movement and scripted fight/rest/equipment. Preserve mining reset/error behavior; see `../docs/combat-progression.md`.
