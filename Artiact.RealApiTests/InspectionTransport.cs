...
internal sealed class InspectionTransport(string character, Func<string, Task<HttpResponseMessage>> read, bool includeItems = false) : IGameHttpClient
{
    public Task<HttpResponseMessage> GetAsync(string requestUri)
    {
        bool allowed = requestUri == "/openapi.json" || requestUri == "/characters/" + Uri.EscapeDataString(character) ||
            ...
            includeItems && System.Text.RegularExpressions.Regex.IsMatch(requestUri, @"\A/items\?page=[1-9][0-9]{0,2}\z");
